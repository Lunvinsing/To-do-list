...
return (
    <header>
      ...
      <div
        className="navbar bg-gradient-to-r from-fuchsia-500 to-cyan-500 shadow-sm w-full"
      >
        <div className="navbar-start ml-3">
        </div>
        <div className="navbar-center mx-auto">
          <a className="text-lg sm:text-xl md:text-2xl text-gray-800 font-bold">
            Checkit
          </a>
        </div>
        ...
        <div className="navbar-end">
          <div className="group relative mr-3">
            <a href="https://github.com/Lunvinsing/To-do-list" target="_blank" className="inline-flex">
